...
<body>
    ...
    <ul class="nav-area">
        ...
        <!--LOGO E PET SHOP ME KONTAKT-->
<div class="welcome-text">
    <br><br> <img src="simba.png" alt="Logosimba" width="450px" style="max-width:100%;height:auto;"><br>
     <a href="kontakti.php">Na Kontakto</a><Br>
